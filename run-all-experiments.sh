...
source run_experiment.sh 3 "${1}_ql1_min0" 10 true ./resources/deployment/graalvm/setups/keda/deployment-0.yaml ./resources/deployment/graalvm/setups/keda/queue-length/ql1_min0.yaml
source run_experiment.sh 3 "${1}_ql1_min1" 10 true ./resources/deployment/graalvm/setups/keda/deployment-0.yaml ./resources/deployment/graalvm/setups/keda/queue-length/ql1_min1.yaml
source run_experiment.sh 3 "${1}_ql1_min2" 15 true ./resources/deployment/graalvm/setups/keda/deployment-0.yaml ./resources/deployment/graalvm/setups/keda/queue-length/ql1_min2.yaml
source run_experiment.sh 3 "${1}_ql1_min3" 15 true ./resources/deployment/graalvm/setups/keda/deployment-0.yaml ./resources/deployment/graalvm/setups/keda/queue-length/ql1_min3.yaml
source run_experiment.sh 3 "${1}_ql1_min4" 15 true ./resources/deployment/graalvm/setups/keda/deployment-0.yaml ./resources/deployment/graalvm/setups/keda/queue-length/ql1_min4.yaml