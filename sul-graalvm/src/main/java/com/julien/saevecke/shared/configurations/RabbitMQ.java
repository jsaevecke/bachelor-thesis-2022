package com.julien.saevecke.shared.configurations;
...
@NativeHint(
        trigger = RabbitMQ.class,
        types = {
                @TypeHint(types = MembershipQuery.class, typeNames = "com.julien.saevecke.shared.messages.MembershipQuery", access = {TypeAccess.DECLARED_CLASSES, TypeAccess.DECLARED_METHODS, TypeAccess.DECLARED_FIELDS, TypeAccess.DECLARED_CONSTRUCTORS}),
                @TypeHint(types = DefaultQueryProxy.class, typeNames = "com.julien.saevecke.shared.messages.DefaultQueryProxy", access = {TypeAccess.DECLARED_CLASSES, TypeAccess.DECLARED_METHODS, TypeAccess.DECLARED_FIELDS, TypeAccess.DECLARED_CONSTRUCTORS})
        }
)
@Configuration
